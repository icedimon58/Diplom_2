...
class TestCreateUser:
    ...
    def test_create_unique_user_positive(self, generate_new_user_and_return_login_password):
    ...
    def test_create_exisiting_user_negative(self, generate_new_user_and_return_login_password):
        payload = generate_new_user_and_return_login_password
